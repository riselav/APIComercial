...
/* Create Tables */
IF NOT EXISTS (SELECT 1 FROM dbo.sysobjects WHERE id = object_id(N'[CAT_Marcas]') AND OBJECTPROPERTY(id, N'IsUserTable') = 1) 
BEGIN
CREATE TABLE [CAT_Marcas]
(
	[nMarca] int NOT NULL,    -- id
	...
	ALTER TABLE [CAT_Marcas] ADD CONSTRAINT [PK_CAT_Marcas]
	PRIMARY KEY CLUSTERED ([nMarca] ASC)
END
GO