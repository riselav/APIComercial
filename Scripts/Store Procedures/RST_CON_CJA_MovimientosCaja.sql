SP_ELIMINASTORE 'RST_CON_CJA_MovimientosCaja'
GO
CREATE PROCEDURE RST_CON_CJA_MovimientosCaja (@nSucursal int,@nCaja int,@nTipoRegistroCaja int)  
AS  
BEGIN  
 -- RST_CON_CJA_MovimientosCaja 1,2,4
 ...
 BEGIN
	...
	SELECT MC.nConsecutivo, MC.nIDRegistroCaja,CC.cDescripcion as cConceptoCaja ,MC.nImporte, MC.dfecha ,MC.cUsuario_Registra, 
	CONVERT(varchar(10), MC.dFecha_Registra,108),MC.cObservaciones,
