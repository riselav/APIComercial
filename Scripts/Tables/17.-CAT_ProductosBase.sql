...
/* Create Tables */
IF NOT EXISTS (SELECT 1 FROM dbo.sysobjects WHERE id = object_id(N'[CAT_ProductosBase]') AND OBJECTPROPERTY(id, N'IsUserTable') = 1) 
BEGIN
CREATE TABLE [CAT_ProductosBase]
(
	[nProductoBase] int NOT NULL,    -- id
	[cDescripcion] varchar(200) NOT NULL,    -- nombre del registro
	[nTipoUnidad] tinyint NOT NULL,    -- indicador de si es de:  1=Peso 2=Liquido 3=Pieza
	...
	ALTER TABLE [CAT_ProductosBase] ADD CONSTRAINT [PK_CAT_ProductosBase]
	PRIMARY KEY CLUSTERED ([nProductoBase] ASC)
END
GO