...
/* Create Tables */
IF NOT EXISTS (SELECT 1 FROM dbo.sysobjects WHERE id = object_id(N'[CAT_ListasPrecio]') AND OBJECTPROPERTY(id, N'IsUserTable') = 1) 
BEGIN
CREATE TABLE [CAT_ListasPrecio]
(
	[nIdLista] int NOT NULL,    -- id
	...
	ALTER TABLE [CAT_ListasPrecio] ADD CONSTRAINT [PK_CAT_ListasPrecio]
	PRIMARY KEY CLUSTERED ([nIdLista] ASC)
END
GO